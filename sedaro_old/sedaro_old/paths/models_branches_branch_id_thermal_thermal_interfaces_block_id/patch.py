...
# body param
SchemaForRequestBodyApplicationJson = ThermalInterfaceUpdate


request_body_thermal_interface_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_thermal_interface_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_thermal_interface_update.serialize(body, content_type)
...
class UpdateThermalInterface(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def update_thermal_interface(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._update_thermal_interface_oapg(
            body=body,
