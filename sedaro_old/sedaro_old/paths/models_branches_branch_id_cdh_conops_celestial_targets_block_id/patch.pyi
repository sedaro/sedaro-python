...
# body param
SchemaForRequestBodyApplicationJson = CelestialTargetUpdate


request_body_celestial_target_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_celestial_target_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_celestial_target_update.serialize(body, content_type)
