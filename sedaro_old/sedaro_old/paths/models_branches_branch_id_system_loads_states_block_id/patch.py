...
# body param
SchemaForRequestBodyApplicationJson = LoadStateUpdate


request_body_load_state_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_load_state_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_load_state_update.serialize(body, content_type)
...
class UpdateLoadState(BaseApi):
    ...
    def update_load_state(
        ...
        return self._update_load_state_oapg(
            body=body,
