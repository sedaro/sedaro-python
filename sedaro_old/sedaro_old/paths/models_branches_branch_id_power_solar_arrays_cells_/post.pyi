...
# body param
SchemaForRequestBodyApplicationJson = SolarCellCreate


request_body_solar_cell_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_solar_cell_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_solar_cell_create.serialize(body, content_type)
...
class CreateSolarCell(BaseApi):
    ...
    def create_solar_cell(
        ...
        return self._create_solar_cell_oapg(
            body=body,
