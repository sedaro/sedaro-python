...
class PathValues(str, enum.Enum):
    ...
    MODELS_BRANCHES_BRANCH_ID_SYSTEM_LOADS_ACTUATORLOADS_ = "/models/branches/{branchId}/system/loads/actuator-loads/"
    MODELS_BRANCHES_BRANCH_ID_SYSTEM_LOADS_ACTUATORLOADS_BLOCK_ID = "/models/branches/{branchId}/system/loads/actuator-loads/{blockId}"
    MODELS_BRANCHES_BRANCH_ID_SYSTEM_LOADS_TEMPCONTROLLOADS_ = "/models/branches/{branchId}/system/loads/temp-control-loads/"
    MODELS_BRANCHES_BRANCH_ID_SYSTEM_LOADS_TEMPCONTROLLOADS_BLOCK_ID = "/models/branches/{branchId}/system/loads/temp-control-loads/{blockId}"
    ...
    MODELS_BRANCHES_BRANCH_ID_GNC_ORBITS_BLOCK_ID = "/models/branches/{branchId}/gnc/orbits/{blockId}"
    ...
    MODELS_BRANCHES_BRANCH_ID_TEMPLATEREFS_ = "/models/branches/{branchId}/template-refs/"
    MODELS_BRANCHES_BRANCH_ID_TEMPLATEREFS_BLOCK_ID = "/models/branches/{branchId}/template-refs/{blockId}"
    SIMULATION_BRANCHES_BRANCH_ID_CONTROL_ = "/simulation/branches/{branchId}/control/"
    SIMULATION_BRANCHES_BRANCH_ID_CONTROL_JOB_ID = "/simulation/branches/{branchId}/control/{jobId}"
    DATA_ = "/data/"
    BRANCHES_BRANCH_ID = "/branches/{branchId}"
    BRANCHES_BRANCH_IDSHAREAUTH_ = "/branches/{branchId}share-auth/"
    BRANCHES_BRANCH_IDCOMMITS_ = "/branches/{branchId}commits/"
    BRANCHES_CURRENT_BRANCH_ID_MERGE_INCOMING_BRANCH_ID = "/branches/{currentBranchId}/merge/{incomingBranchId}"
    BRANCHES_BRANCH_IDCOMMITTED_ = "/branches/{branchId}committed/"
    BRANCHES_BRANCH_IDSAVED_ = "/branches/{branchId}saved/"
