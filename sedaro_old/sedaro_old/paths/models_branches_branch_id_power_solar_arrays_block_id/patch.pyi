...
# body param
SchemaForRequestBodyApplicationJson = SolarArrayUpdate


request_body_solar_array_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_solar_array_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_solar_array_update.serialize(body, content_type)
...
class UpdateSolarArray(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def update_solar_array(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._update_solar_array_oapg(
            body=body,
