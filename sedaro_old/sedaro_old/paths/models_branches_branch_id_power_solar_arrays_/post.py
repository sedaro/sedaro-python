...
# body param
SchemaForRequestBodyApplicationJson = SolarArrayCreate


request_body_solar_array_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_solar_array_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_solar_array_create.serialize(body, content_type)
...
class CreateSolarArray(BaseApi):
    ...
    def create_solar_array(
        ...
        return self._create_solar_array_oapg(
            body=body,
