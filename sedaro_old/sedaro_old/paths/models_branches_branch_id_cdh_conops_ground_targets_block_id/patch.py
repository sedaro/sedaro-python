...
# body param
SchemaForRequestBodyApplicationJson = GroundTargetUpdate


request_body_ground_target_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_ground_target_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ground_target_update.serialize(body, content_type)
