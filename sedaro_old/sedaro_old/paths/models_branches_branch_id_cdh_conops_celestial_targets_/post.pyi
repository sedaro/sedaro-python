...
# body param
SchemaForRequestBodyApplicationJson = CelestialTargetCreate


request_body_celestial_target_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_celestial_target_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_celestial_target_create.serialize(body, content_type)
