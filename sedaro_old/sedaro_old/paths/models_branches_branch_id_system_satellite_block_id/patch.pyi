...
# body param
SchemaForRequestBodyApplicationJson = SatelliteUpdate


request_body_satellite_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_satellite_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_satellite_update.serialize(body, content_type)
...
class UpdateSatellite(BaseApi):
    ...
    def update_satellite(
        ...
        return self._update_satellite_oapg(
            body=body,
