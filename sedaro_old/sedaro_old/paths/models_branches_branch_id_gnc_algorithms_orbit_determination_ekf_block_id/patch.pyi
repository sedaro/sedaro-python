...
# body param
SchemaForRequestBodyApplicationJson = EKFAlgorithmUpdate


request_body_ekf_algorithm_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_ekf_algorithm_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ekf_algorithm_update.serialize(body, content_type)
...
class UpdateEkfAlgorithm(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def update_ekf_algorithm(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._update_ekf_algorithm_oapg(
            body=body,
