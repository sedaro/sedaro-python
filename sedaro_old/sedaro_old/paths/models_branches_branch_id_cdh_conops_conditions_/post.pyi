...
# body param
SchemaForRequestBodyApplicationJson = ConditionCreate


request_body_condition_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_condition_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_condition_create.serialize(body, content_type)
