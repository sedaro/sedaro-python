...
# body param
SchemaForRequestBodyApplicationJson = SubsystemUpdate


request_body_subsystem_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_subsystem_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subsystem_update.serialize(body, content_type)
...
class UpdateSubsystem(BaseApi):
    ...
    def update_subsystem(
        ...
        return self._update_subsystem_oapg(
            body=body,
