...
# body param
SchemaForRequestBodyApplicationJson = SpaceTargetCreate


request_body_space_target_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_space_target_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_space_target_create.serialize(body, content_type)
...
class CreateSpaceTarget(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_space_target(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._create_space_target_oapg(
            body=body,
