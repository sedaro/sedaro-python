...
# body param
SchemaForRequestBodyApplicationJson = LoadStateCreate


request_body_load_state_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_load_state_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_load_state_create.serialize(body, content_type)
...
class CreateLoadState(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_load_state(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._create_load_state_oapg(
            body=body,
