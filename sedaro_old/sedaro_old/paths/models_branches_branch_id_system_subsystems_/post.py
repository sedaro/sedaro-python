...
# body param
SchemaForRequestBodyApplicationJson = SubsystemCreate


request_body_subsystem_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_subsystem_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subsystem_create.serialize(body, content_type)
...
class CreateSubsystem(BaseApi):
    ...
    def create_subsystem(
        ...
        return self._create_subsystem_oapg(
            body=body,
