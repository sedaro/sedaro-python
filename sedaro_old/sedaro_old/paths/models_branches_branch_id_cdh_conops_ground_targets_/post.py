...
# body param
SchemaForRequestBodyApplicationJson = GroundTargetCreate


request_body_ground_target_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_ground_target_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ground_target_create.serialize(body, content_type)
