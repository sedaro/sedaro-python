...
class PositionSensorCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "oneSigmaDistanceError", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "temperature", "fieldOfView", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "oneSigmaDistanceError", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "temperature", "fieldOfView", ], str]):
