...
class ActivePointingMode(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "lockVector", "lockBodyFrameVector", "acAlgorithm", "id", "odAlgorithm", "adAlgorithm", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "lockVector", "lockBodyFrameVector", "acAlgorithm", "id", "odAlgorithm", "adAlgorithm", ], str]):
