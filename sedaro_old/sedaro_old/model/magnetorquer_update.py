...
class MagnetorquerUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "bodyFrameVector", "ratedMagneticMoment", "powerAtRatedMagneticMoment", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "temperature", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "bodyFrameVector", "ratedMagneticMoment", "powerAtRatedMagneticMoment", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "temperature", ], str]):
