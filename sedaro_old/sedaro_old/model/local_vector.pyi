...
class LocalVector(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "vectorType", "satellite", "localPointingDirection", "id", "truth", "estimate", "pointingModes_A", "pointingModes_B", "FOVConstraints", "directionSensors", "vectorSensors", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "vectorType", "satellite", "localPointingDirection", "id", "truth", "estimate", "pointingModes_A", "pointingModes_B", "FOVConstraints", "directionSensors", "vectorSensors", ], str]):
