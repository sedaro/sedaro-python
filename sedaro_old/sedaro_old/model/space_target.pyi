...
class SpaceTarget(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "conOps", "id", "targetType", "conditions_A", "conditions_B", "targetVectors", "targetGroups", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "conOps", "id", "targetType", "conditions_A", "conditions_B", "targetVectors", "targetGroups", ], str]):
