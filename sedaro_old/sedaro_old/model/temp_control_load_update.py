...
class TempControlLoadUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "epsOutputType", "id", "busRegulator", "topology", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "epsOutputType", "id", "busRegulator", "topology", ], str]):
