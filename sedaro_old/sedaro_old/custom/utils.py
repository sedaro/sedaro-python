...
def parse_block_crud_response(response: ApiResponse) -> Dict:
    ...
    Returns:
        Dict: a dictionary as follows: `'block_id`', `'block_data'`, `'block_group'`, `'branch_data'`, `'action'`
    """
    body = response.body
    ...
    return {
        'block_id': block_id,
        'block_data': branch_data[block_group][block_id],
