...
# body param
SchemaForRequestBodyApplicationJson = FOVConstraintUpdate


request_body_fov_constraint_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_field_of_view_constraint_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_fov_constraint_update.serialize(body, content_type)
...
class UpdateFieldOfViewConstraint(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def update_field_of_view_constraint(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._update_field_of_view_constraint_oapg(
            body=body,
