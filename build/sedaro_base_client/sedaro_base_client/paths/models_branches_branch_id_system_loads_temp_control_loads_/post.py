...
# body param
SchemaForRequestBodyApplicationJson = TempControlLoadCreate


request_body_temp_control_load_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_temperature_controller_load_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_temp_control_load_create.serialize(body, content_type)
