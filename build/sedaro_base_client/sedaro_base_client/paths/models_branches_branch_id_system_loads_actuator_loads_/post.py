...
# body param
SchemaForRequestBodyApplicationJson = ActuatorLoadCreate


request_body_actuator_load_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_actuator_load_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_actuator_load_create.serialize(body, content_type)
...
class CreateActuatorLoad(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_actuator_load(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._create_actuator_load_oapg(
            body=body,
