<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.battery_api.BatteryApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**update_battery**](#update_battery) | **patch** /models/branches/{branchId}/power/batteries/{blockId} | Update Battery
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    body = BatteryUpdate(
        ...
        initial_soc=0.0,
        max_charge_current_override=0.0,
        max_discharge_current_override=0.0,
        min_soc_override=0.0,
    )
    try:
        # Update Battery
        api_response = api_instance.update_battery(
...
------------- | ------------- | -------------
[**BatteryUpdate**](../../models/BatteryUpdate.md) |  | 
...
200 | [ApiResponseFor200](#update_battery.ApiResponseFor200) | Successful Response
422 | [ApiResponseFor422](#update_battery.ApiResponseFor422) | Validation Error

#### update_battery.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
