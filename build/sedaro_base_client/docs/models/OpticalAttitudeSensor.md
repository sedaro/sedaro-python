# sedaro_base_client.model.optical_attitude_sensor.OpticalAttitudeSensor
...
------------ | ------------- | ------------- | ------------- | -------------
**componentType** | str,  | str,  |  | must be one of ["OPTICAL_ATTITUDE_SENSOR", ] 
**name** | str,  | str,  |  | 
...
**crossAxisError** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
**boresightAxisError** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
