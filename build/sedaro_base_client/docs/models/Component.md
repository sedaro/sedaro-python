# sedaro_base_client.model.component.Component
...
**componentType** | str,  | str,  |  | [optional] must be one of ["GENERIC", ] if omitted the server will use the default value of "GENERIC"
