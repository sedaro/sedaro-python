# sedaro_base_client.model.reaction_wheel.ReactionWheel
...
**componentType** | str,  | str,  |  | must be one of ["REACTION_WHEEL", ] 
**efficiency** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**inertia** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**ratedTorque** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**name** | str,  | str,  |  | 
...
**ratedMomentum** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**id** | str,  | str,  |  | [optional] 
...
**momentum** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
**speed** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
**torqueMargin** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
**momentumMargin** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
