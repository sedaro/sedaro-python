# sedaro_base_client.model.con_ops_bg.ConOpsBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**ConOps**](ConOps.md) | [**ConOps**](ConOps.md) | any string name can be used but the value must be the correct type | [optional] 
