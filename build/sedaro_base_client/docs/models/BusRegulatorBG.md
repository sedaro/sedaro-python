# sedaro_base_client.model.bus_regulator_bg.BusRegulatorBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**BusRegulator**](BusRegulator.md) | [**BusRegulator**](BusRegulator.md) | any string name can be used but the value must be the correct type | [optional] 
