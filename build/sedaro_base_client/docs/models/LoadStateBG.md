# sedaro_base_client.model.load_state_bg.LoadStateBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**LoadState**](LoadState.md) | [**LoadState**](LoadState.md) | any string name can be used but the value must be the correct type | [optional] 
