...
class ReferenceVector(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def vectorType() -> typing.Type['ReferenceVectorTypes']:
                return ReferenceVectorTypes
    ...
    vectorType: 'ReferenceVectorTypes'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["vectorType"]) -> 'ReferenceVectorTypes': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "vectorType", "satellite", "id", "truth", "estimate", "pointingModes_A", "pointingModes_B", "FOVConstraints", "directionSensors", "vectorSensors", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vectorType"]) -> 'ReferenceVectorTypes': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "vectorType", "satellite", "id", "truth", "estimate", "pointingModes_A", "pointingModes_B", "FOVConstraints", "directionSensors", "vectorSensors", ], str]):
