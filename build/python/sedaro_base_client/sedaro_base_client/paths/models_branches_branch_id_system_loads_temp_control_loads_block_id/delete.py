...
class BaseApi(api_client.Api):
    ...
    def _delete_temperature_controller_load_oapg(
        self: api_client.Api,
...
class DeleteTemperatureControllerLoad(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def delete_temperature_controller_load(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._delete_temperature_controller_load_oapg(
