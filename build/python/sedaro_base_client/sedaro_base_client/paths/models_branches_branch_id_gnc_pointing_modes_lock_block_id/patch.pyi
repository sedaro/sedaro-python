...
# body param
SchemaForRequestBodyApplicationJson = LockPointingModeUpdate


request_body_lock_pointing_mode_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_direction_lock_pointing_mode_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_lock_pointing_mode_update.serialize(body, content_type)
...
class UpdateDirectionLockPointingMode(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def update_direction_lock_pointing_mode(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._update_direction_lock_pointing_mode_oapg(
            body=body,
