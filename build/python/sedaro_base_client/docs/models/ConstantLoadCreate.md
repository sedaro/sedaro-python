# sedaro_base_client.model.constant_load_create.ConstantLoadCreate
...
------------ | ------------- | ------------- | ------------- | -------------
**[loadDefParams](#loadDefParams)** | dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader,  | frozendict.frozendict, str, decimal.Decimal, BoolClass, NoneClass, tuple, bytes, FileIO |  | 
...
**[loadDefType](#loadDefType)** | dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader,  | frozendict.frozendict, str, decimal.Decimal, BoolClass, NoneClass, tuple, bytes, FileIO |  | 
**name** | str,  | str,  |  | 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[ConstantLoadDefinitionTypes](ConstantLoadDefinitionTypes.md) | [**ConstantLoadDefinitionTypes**](ConstantLoadDefinitionTypes.md) | [**ConstantLoadDefinitionTypes**](ConstantLoadDefinitionTypes.md) |  | 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[ConstantPower](ConstantPower.md) | [**ConstantPower**](ConstantPower.md) | [**ConstantPower**](ConstantPower.md) |  | 
[ConstantResistance](ConstantResistance.md) | [**ConstantResistance**](ConstantResistance.md) | [**ConstantResistance**](ConstantResistance.md) |  | 
