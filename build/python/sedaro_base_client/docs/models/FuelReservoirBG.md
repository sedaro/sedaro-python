# sedaro_base_client.model.fuel_reservoir_bg.FuelReservoirBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**FuelReservoir**](FuelReservoir.md) | [**FuelReservoir**](FuelReservoir.md) | any string name can be used but the value must be the correct type | [optional] 
