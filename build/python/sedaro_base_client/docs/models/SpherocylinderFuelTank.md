# sedaro_base_client.model.spherocylinder_fuel_tank.SpherocylinderFuelTank
...
------------ | ------------- | ------------- | ------------- | -------------
**componentType** | str,  | str,  |  | must be one of ["SPHEROCYLINDER_FUEL_TANK", ] 
**orientationVector** | str,  | str,  | Relationship to a &#x60;BodyFrameVector&#x60; block. On delete: &#x60;RESTRICT&#x60; (prevent referenced block from being deleted while relationship to this one exists). | 
...
**priority** | decimal.Decimal, int,  | decimal.Decimal,  |  | 
**capacity** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**cylinderLength** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**[inertia](#inertia)** | list, tuple,  | tuple,  |  | 
**capDiameter** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**flowRate** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**name** | str,  | str,  |  | 
**[location](#location)** | list, tuple,  | tuple,  |  | 
**reservoir** | str,  | str,  | Relationship to a &#x60;FuelReservoir&#x60; block. Reverse key: &#x60;FuelReservoir.fuelTanks&#x60;. On delete: &#x60;RESTRICT&#x60; (prevent referenced block from being deleted while relationship to this one exists). | 
**wetMass** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**id** | str,  | str,  |  | [optional] 
