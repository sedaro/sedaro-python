# sedaro_base_client.model.target_group_bg.TargetGroupBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**TargetGroup**](TargetGroup.md) | [**TargetGroup**](TargetGroup.md) | any string name can be used but the value must be the correct type | [optional] 
