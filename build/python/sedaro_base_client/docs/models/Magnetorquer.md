# sedaro_base_client.model.magnetorquer.Magnetorquer
...
------------ | ------------- | ------------- | ------------- | -------------
**bodyFrameVector** | str,  | str,  | Relationship to a &#x60;BodyFrameVector&#x60; block. Reverse key: &#x60;BodyFrameVector.actuators&#x60;. On delete: &#x60;RESTRICT&#x60; (prevent referenced block from being deleted while relationship to this one exists). | 
**componentType** | str,  | str,  |  | must be one of ["MAGNETORQUER", ] 
**ratedMagneticMoment** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**name** | str,  | str,  |  | 
...
**powerAtRatedMagneticMoment** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
**id** | str,  | str,  |  | [optional] 
...
**powerConsumed** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
...
**[maxTorque](#maxTorque)** | list, tuple,  | tuple,  |  | [optional] 
**commandedTorqueMagnitude** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
**[estimatedMagneticFieldVector](#estimatedMagneticFieldVector)** | list, tuple,  | tuple,  |  | [optional] 
**pwmDutyCycle** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
**magneticMoment** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
**magneticMomentMargin** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] 
