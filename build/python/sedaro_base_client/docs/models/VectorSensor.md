# sedaro_base_client.model.vector_sensor.VectorSensor
...
------------ | ------------- | ------------- | ------------- | -------------
**componentType** | str,  | str,  |  | must be one of ["VECTOR_SENSOR", ] 
**name** | str,  | str,  |  | 
...
**[triadAlgorithms](#triadAlgorithms)** | list, tuple,  | tuple,  | Relationship to one or more &#x60;TriadAlgorithm&#x60; blocks. Reverse key: &#x60;TriadAlgorithm.vectorSensors&#x60;. On delete: &#x60;SET_NONE&#x60; (remove ID of referenced block from this relationship field). | [optional] 
...
Relationship to one or more `TriadAlgorithm` blocks. Reverse key: `TriadAlgorithm.vectorSensors`. On delete: `SET_NONE` (remove ID of referenced block from this relationship field).

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Relationship to one or more &#x60;TriadAlgorithm&#x60; blocks. Reverse key: &#x60;TriadAlgorithm.vectorSensors&#x60;. On delete: &#x60;SET_NONE&#x60; (remove ID of referenced block from this relationship field). | 
