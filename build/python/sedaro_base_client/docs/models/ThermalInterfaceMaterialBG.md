# sedaro_base_client.model.thermal_interface_material_bg.ThermalInterfaceMaterialBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**ThermalInterfaceMaterial**](ThermalInterfaceMaterial.md) | [**ThermalInterfaceMaterial**](ThermalInterfaceMaterial.md) | any string name can be used but the value must be the correct type | [optional] 
