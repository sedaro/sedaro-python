# sedaro_base_client.model.solar_cell_bg.SolarCellBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**SolarCell**](SolarCell.md) | [**SolarCell**](SolarCell.md) | any string name can be used but the value must be the correct type | [optional] 
