# sedaro_base_client.model.subsystem_bg.SubsystemBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**Subsystem**](Subsystem.md) | [**Subsystem**](Subsystem.md) | any string name can be used but the value must be the correct type | [optional] 
