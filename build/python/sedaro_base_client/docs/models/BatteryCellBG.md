# sedaro_base_client.model.battery_cell_bg.BatteryCellBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**BatteryCell**](BatteryCell.md) | [**BatteryCell**](BatteryCell.md) | any string name can be used but the value must be the correct type | [optional] 
