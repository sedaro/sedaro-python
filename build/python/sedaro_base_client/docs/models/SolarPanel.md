# sedaro_base_client.model.solar_panel.SolarPanel
...
**componentType** | str,  | str,  |  | [optional] must be one of ["SOLAR_PANEL", ] if omitted the server will use the default value of "SOLAR_PANEL"
