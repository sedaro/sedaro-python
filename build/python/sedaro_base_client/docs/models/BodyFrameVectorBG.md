# sedaro_base_client.model.body_frame_vector_bg.BodyFrameVectorBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**BodyFrameVector**](BodyFrameVector.md) | [**BodyFrameVector**](BodyFrameVector.md) | any string name can be used but the value must be the correct type | [optional] 
