# sedaro_base_client.model.agent_bg.AgentBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**Agent**](Agent.md) | [**Agent**](Agent.md) | any string name can be used but the value must be the correct type | [optional] 
