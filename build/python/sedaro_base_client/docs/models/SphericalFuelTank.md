# sedaro_base_client.model.spherical_fuel_tank.SphericalFuelTank
...
------------ | ------------- | ------------- | ------------- | -------------
**componentType** | str,  | str,  |  | must be one of ["SPHERICAL_FUEL_TANK", ] 
**[inertia](#inertia)** | list, tuple,  | tuple,  |  | 
**diameter** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
