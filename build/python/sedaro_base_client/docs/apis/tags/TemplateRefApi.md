<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.template_ref_api.TemplateRefApi
...
from sedaro_base_client.apis.tags import template_ref_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = template_ref_api.TemplateRefApi(api_client)
    ...
    try:
        ...
        print("Exception when calling TemplateRefApi->create_agent_template_reference: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TemplateRefApi->delete_agent_template_reference: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TemplateRefApi->update_agent_template_reference: %s\n" % e)
```
### Parameters
