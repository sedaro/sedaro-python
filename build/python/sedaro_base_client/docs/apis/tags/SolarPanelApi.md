<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.solar_panel_api.SolarPanelApi
...
from sedaro_base_client.apis.tags import solar_panel_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = solar_panel_api.SolarPanelApi(api_client)
    ...
    try:
        ...
        print("Exception when calling SolarPanelApi->create_solar_panel: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SolarPanelApi->delete_solar_panel: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SolarPanelApi->update_solar_panel: %s\n" % e)
```
### Parameters
