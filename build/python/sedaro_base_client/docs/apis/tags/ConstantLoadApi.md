<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.constant_load_api.ConstantLoadApi
...
from sedaro_base_client.apis.tags import constant_load_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = constant_load_api.ConstantLoadApi(api_client)
    ...
    try:
        ...
        print("Exception when calling ConstantLoadApi->create_constant_load: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ConstantLoadApi->delete_constant_load: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ConstantLoadApi->update_constant_load: %s\n" % e)
```
### Parameters
