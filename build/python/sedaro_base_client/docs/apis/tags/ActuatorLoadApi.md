<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.actuator_load_api.ActuatorLoadApi
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ActuatorLoadApi->delete_actuator_load: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ActuatorLoadApi->update_actuator_load: %s\n" % e)
```
### Parameters
