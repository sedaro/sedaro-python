<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.position_sensor_api.PositionSensorApi
...
from sedaro_base_client.apis.tags import position_sensor_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = position_sensor_api.PositionSensorApi(api_client)
    ...
    try:
        ...
        print("Exception when calling PositionSensorApi->create_positionsensor: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PositionSensorApi->delete_positionsensor: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PositionSensorApi->update_positionsensor: %s\n" % e)
```
### Parameters
