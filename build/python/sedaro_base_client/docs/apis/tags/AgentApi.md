<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.agent_api.AgentApi
...
from sedaro_base_client.apis.tags import agent_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling AgentApi->create_simulated_agent: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling AgentApi->delete_simulated_agent: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling AgentApi->update_simulated_agent: %s\n" % e)
```
### Parameters
