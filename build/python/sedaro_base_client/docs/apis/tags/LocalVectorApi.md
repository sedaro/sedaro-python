<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.local_vector_api.LocalVectorApi
...
from sedaro_base_client.apis.tags import local_vector_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = local_vector_api.LocalVectorApi(api_client)
    ...
    try:
        ...
        print("Exception when calling LocalVectorApi->create_local_vector: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LocalVectorApi->delete_local_vector: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LocalVectorApi->update_local_vector: %s\n" % e)
```
### Parameters
