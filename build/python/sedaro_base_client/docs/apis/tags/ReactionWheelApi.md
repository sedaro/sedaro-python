<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.reaction_wheel_api.ReactionWheelApi
...
from sedaro_base_client.apis.tags import reaction_wheel_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = reaction_wheel_api.ReactionWheelApi(api_client)
    ...
    try:
        ...
        print("Exception when calling ReactionWheelApi->create_reaction_wheel: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ReactionWheelApi->delete_reaction_wheel: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ReactionWheelApi->update_reaction_wheel: %s\n" % e)
```
### Parameters
