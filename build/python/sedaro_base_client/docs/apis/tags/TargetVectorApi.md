<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.target_vector_api.TargetVectorApi
...
from sedaro_base_client.apis.tags import target_vector_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = target_vector_api.TargetVectorApi(api_client)
    ...
    try:
        ...
        print("Exception when calling TargetVectorApi->create_target_vector: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TargetVectorApi->delete_target_vector: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TargetVectorApi->update_target_vector: %s\n" % e)
```
### Parameters
