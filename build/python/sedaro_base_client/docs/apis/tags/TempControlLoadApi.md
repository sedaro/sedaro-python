<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.temp_control_load_api.TempControlLoadApi
...
from sedaro_base_client.apis.tags import temp_control_load_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = temp_control_load_api.TempControlLoadApi(api_client)
    ...
    try:
        ...
        print("Exception when calling TempControlLoadApi->create_temperature_controller_load: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TempControlLoadApi->delete_temperature_controller_load: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TempControlLoadApi->update_temperature_controller_load: %s\n" % e)
```
### Parameters
