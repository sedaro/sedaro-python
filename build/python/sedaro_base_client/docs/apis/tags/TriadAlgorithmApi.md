<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.triad_algorithm_api.TriadAlgorithmApi
...
from sedaro_base_client.apis.tags import triad_algorithm_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = triad_algorithm_api.TriadAlgorithmApi(api_client)
    ...
    try:
        ...
        print("Exception when calling TriadAlgorithmApi->create_triad_algorithm: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TriadAlgorithmApi->delete_triad_algorithm: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TriadAlgorithmApi->update_triad_algorithm: %s\n" % e)
```
### Parameters
