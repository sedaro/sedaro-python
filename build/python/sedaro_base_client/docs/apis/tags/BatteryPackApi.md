<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.battery_pack_api.BatteryPackApi
...
from sedaro_base_client.apis.tags import battery_pack_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = battery_pack_api.BatteryPackApi(api_client)
    ...
    try:
        ...
        print("Exception when calling BatteryPackApi->create_battery_pack: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling BatteryPackApi->delete_battery_pack: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling BatteryPackApi->update_battery_pack: %s\n" % e)
```
### Parameters
