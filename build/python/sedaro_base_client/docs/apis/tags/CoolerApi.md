<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.cooler_api.CoolerApi
...
from sedaro_base_client.apis.tags import cooler_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = cooler_api.CoolerApi(api_client)
    ...
    try:
        ...
        print("Exception when calling CoolerApi->create_cooler: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CoolerApi->delete_cooler: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CoolerApi->update_cooler: %s\n" % e)
```
### Parameters
