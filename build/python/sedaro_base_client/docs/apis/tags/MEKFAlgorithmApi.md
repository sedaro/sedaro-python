<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.mekf_algorithm_api.MEKFAlgorithmApi
...
from sedaro_base_client.apis.tags import mekf_algorithm_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = mekf_algorithm_api.MEKFAlgorithmApi(api_client)
    ...
    try:
        ...
        print("Exception when calling MEKFAlgorithmApi->create_mekf_algorithm: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MEKFAlgorithmApi->delete_mekf_algorithm: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MEKFAlgorithmApi->update_mekf_algorithm: %s\n" % e)
```
### Parameters
