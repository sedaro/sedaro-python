<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.magnetorquer_api.MagnetorquerApi
...
from sedaro_base_client.apis.tags import magnetorquer_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = magnetorquer_api.MagnetorquerApi(api_client)
    ...
    try:
        ...
        print("Exception when calling MagnetorquerApi->create_magnetorquer: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MagnetorquerApi->delete_magnetorquer: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MagnetorquerApi->update_magnetorquer: %s\n" % e)
```
### Parameters
