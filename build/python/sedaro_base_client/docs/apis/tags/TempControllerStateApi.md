<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.temp_controller_state_api.TempControllerStateApi
...
from sedaro_base_client.apis.tags import temp_controller_state_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = temp_controller_state_api.TempControllerStateApi(api_client)
    ...
    try:
        ...
        print("Exception when calling TempControllerStateApi->create_temperature_controller_state: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TempControllerStateApi->delete_temperature_controller_state: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TempControllerStateApi->update_temperature_controller_state: %s\n" % e)
```
### Parameters
