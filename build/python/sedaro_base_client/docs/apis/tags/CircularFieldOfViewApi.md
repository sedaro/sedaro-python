<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.circular_field_of_view_api.CircularFieldOfViewApi
...
from sedaro_base_client.apis.tags import circular_field_of_view_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = circular_field_of_view_api.CircularFieldOfViewApi(api_client)
    ...
    try:
        ...
        print("Exception when calling CircularFieldOfViewApi->create_circular_field_of_view: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CircularFieldOfViewApi->delete_circular_field_of_view: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CircularFieldOfViewApi->update_circular_field_of_view: %s\n" % e)
```
### Parameters
