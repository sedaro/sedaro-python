<a name="__pageTop"></a>
# sedaro_base_client.apis.tags.vector_sensor_api.VectorSensorApi
...
from sedaro_base_client.apis.tags import vector_sensor_api
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    api_instance = vector_sensor_api.VectorSensorApi(api_client)
    ...
    try:
        ...
        print("Exception when calling VectorSensorApi->create_vector_sensor: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VectorSensorApi->delete_vector_sensor: %s\n" % e)
```
### Parameters
...
with sedaro_base_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VectorSensorApi->update_vector_sensor: %s\n" % e)
```
### Parameters
