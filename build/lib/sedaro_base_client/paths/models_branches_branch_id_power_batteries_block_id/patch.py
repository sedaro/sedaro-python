...
# body param
SchemaForRequestBodyApplicationJson = BatteryUpdate


request_body_battery_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_battery_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_battery_update.serialize(body, content_type)
...
class UpdateBattery(BaseApi):
    ...
    def update_battery(
        ...
        return self._update_battery_oapg(
            body=body,
