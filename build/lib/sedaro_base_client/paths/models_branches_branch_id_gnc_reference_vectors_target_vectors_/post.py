...
# body param
SchemaForRequestBodyApplicationJson = TargetVectorCreate


request_body_target_vector_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_target_vector_oapg(
        self,
    ...
    def _create_target_vector_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_target_vector_create.serialize(body, content_type)
...
class CreateTargetVector(BaseApi):
    ...
    def create_target_vector(
        ...
        return self._create_target_vector_oapg(
            body=body,
