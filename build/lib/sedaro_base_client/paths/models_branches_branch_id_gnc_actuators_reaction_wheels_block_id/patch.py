...
# body param
SchemaForRequestBodyApplicationJson = ReactionWheelUpdate


request_body_reaction_wheel_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_reaction_wheel_oapg(
        self,
    ...
    def _update_reaction_wheel_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_reaction_wheel_update.serialize(body, content_type)
...
class UpdateReactionWheel(BaseApi):
    ...
    def update_reaction_wheel(
        ...
        return self._update_reaction_wheel_oapg(
            body=body,
