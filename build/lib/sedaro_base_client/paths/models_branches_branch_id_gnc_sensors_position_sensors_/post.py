...
# body param
SchemaForRequestBodyApplicationJson = PositionSensorCreate


request_body_position_sensor_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_position_sensor_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_position_sensor_create.serialize(body, content_type)
