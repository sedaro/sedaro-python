...
# body param
SchemaForRequestBodyApplicationJson = MagnetorquerUpdate


request_body_magnetorquer_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_magnetorquer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_magnetorquer_update.serialize(body, content_type)
...
class UpdateMagnetorquer(BaseApi):
    ...
    def update_magnetorquer(
        ...
        return self._update_magnetorquer_oapg(
            body=body,
