...
# body param
SchemaForRequestBodyApplicationJson = ConditionUpdate


request_body_condition_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_condition_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_condition_update.serialize(body, content_type)
...
class UpdateCondition(BaseApi):
    ...
    def update_condition(
        ...
        return self._update_condition_oapg(
            body=body,
