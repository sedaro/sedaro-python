...
# body param
SchemaForRequestBodyApplicationJson = CoolerUpdate


request_body_cooler_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_cooler_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cooler_update.serialize(body, content_type)
...
class UpdateCooler(BaseApi):
    ...
    def update_cooler(
        ...
        return self._update_cooler_oapg(
            body=body,
