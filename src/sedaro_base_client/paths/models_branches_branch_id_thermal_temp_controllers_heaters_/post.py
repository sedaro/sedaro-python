...
# body param
SchemaForRequestBodyApplicationJson = HeaterCreate


request_body_heater_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_heater_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_heater_create.serialize(body, content_type)
...
class CreateHeater(BaseApi):
    ...
    def create_heater(
        ...
        return self._create_heater_oapg(
            body=body,
