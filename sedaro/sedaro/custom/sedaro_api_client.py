...
class SedaroApiClient(ApiClient):
    ...
    def get_block_client(self, branch_id: int, block_name: str) -> BlockClient:
        ...
        block_api_module = import_module(f'{PACKAGE_NAME}.apis.tags.{block_snake_case}_api')
        block_open_api_instance: Api = getattr(block_api_module, f'{block_pascal_case}Api')(self)
