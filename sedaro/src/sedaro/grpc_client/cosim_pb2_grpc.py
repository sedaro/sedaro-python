...
class CosimStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.CosimCall = channel.stream_stream(
...
class CosimServicer(object):
    ...
    def CosimCall(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        print("CosimCall")
...
def add_CosimServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'CosimCall': grpc.stream_stream_rpc_method_handler(
            servicer.CosimCall,
...
class Cosim(object):
    ...
    @staticmethod
    def CosimCall(request_iterator,
                  target,
                  options=(),
