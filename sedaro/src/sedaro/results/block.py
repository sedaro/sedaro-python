...
from .utils import (ENGINE_EXPANSION, ENGINE_MAP, 
                    HFILL, get_column_names, hfill,
...
class SedaroBlockResult(FromFileAndToFileAreDeprecated, StatFunctions):
    ...
    def modules(self) -> List[str]:
        '''Get the list of modules in this agent.'''
        return [ ENGINE_EXPANSION[ENGINE_MAP[module.split("/")[1]]] for module in self.modules]
