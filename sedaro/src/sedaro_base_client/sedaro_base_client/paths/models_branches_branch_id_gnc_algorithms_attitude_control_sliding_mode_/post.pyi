...
# body param
SchemaForRequestBodyApplicationJson = SlidingModeAlgorithmCreate


request_body_sliding_mode_algorithm_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_sliding_mode3x3_algorithm_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sliding_mode_algorithm_create.serialize(body, content_type)
...
class CreateSlidingMode3x3Algorithm(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def create_sliding_mode3x3_algorithm(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._create_sliding_mode3x3_algorithm_oapg(
            body=body,
