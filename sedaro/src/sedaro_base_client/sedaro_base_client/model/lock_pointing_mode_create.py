...
class LockPointingModeCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "conOps", "lockVector", "lockBodyFrameVector", "acAlgorithm", "spinRate", "id", "odAlgorithm", "adAlgorithm", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "conOps", "lockVector", "lockBodyFrameVector", "acAlgorithm", "spinRate", "id", "odAlgorithm", "adAlgorithm", ], str]):
