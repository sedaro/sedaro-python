...
# body param
SchemaForRequestBodyApplicationJson = OrbitUpdate


request_body_orbit_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_orbit_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_orbit_update.serialize(body, content_type)
...
class UpdateOrbit(BaseApi):
    ...
    def update_orbit(
        ...
        return self._update_orbit_oapg(
            body=body,
