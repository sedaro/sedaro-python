...
# body param
SchemaForRequestBodyApplicationJson = HeaterUpdate


request_body_heater_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_heater_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_heater_update.serialize(body, content_type)
...
class UpdateHeater(BaseApi):
    ...
    def update_heater(
        ...
        return self._update_heater_oapg(
            body=body,
