...
# body param
SchemaForRequestBodyApplicationJson = SurfaceUpdate


request_body_surface_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_surface_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_surface_update.serialize(body, content_type)
...
class UpdateSurface(BaseApi):
    ...
    def update_surface(
        ...
        return self._update_surface_oapg(
            body=body,
