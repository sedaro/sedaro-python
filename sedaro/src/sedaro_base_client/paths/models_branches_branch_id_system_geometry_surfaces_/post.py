...
# body param
SchemaForRequestBodyApplicationJson = SurfaceCreate


request_body_surface_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_surface_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_surface_create.serialize(body, content_type)
...
class CreateSurface(BaseApi):
    ...
    def create_surface(
        ...
        return self._create_surface_oapg(
            body=body,
