...
# body param
SchemaForRequestBodyApplicationJson = BatteryCellUpdate


request_body_battery_cell_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_battery_cell_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_battery_cell_update.serialize(body, content_type)
...
class UpdateBatteryCell(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_battery_cell(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_battery_cell(
        ...
        return self._update_battery_cell_oapg(
            body=body,
