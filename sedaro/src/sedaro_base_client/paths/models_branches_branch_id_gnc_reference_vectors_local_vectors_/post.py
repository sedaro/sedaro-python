...
# body param
SchemaForRequestBodyApplicationJson = LocalVectorCreate


request_body_local_vector_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_local_vector_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_local_vector_create.serialize(body, content_type)
...
class CreateLocalVector(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_local_vector(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def create_local_vector(
        ...
        return self._create_local_vector_oapg(
            body=body,
