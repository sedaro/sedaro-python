...
# body param
SchemaForRequestBodyApplicationJson = FOVConstraintCreate


request_body_fov_constraint_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_fov_constraint_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_fov_constraint_create.serialize(body, content_type)
