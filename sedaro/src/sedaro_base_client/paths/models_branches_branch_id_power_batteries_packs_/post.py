...
# body param
SchemaForRequestBodyApplicationJson = BatteryPackCreate


request_body_battery_pack_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_battery_pack_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_battery_pack_create.serialize(body, content_type)
...
class CreateBatteryPack(BaseApi):
    ...
    def create_battery_pack(
        ...
        return self._create_battery_pack_oapg(
            body=body,
