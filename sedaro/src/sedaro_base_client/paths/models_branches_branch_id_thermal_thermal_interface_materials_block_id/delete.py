...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_thermal_interface_material_oapg(
        self,
...
class DeleteThermalInterfaceMaterial(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_thermal_interface_material(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_thermal_interface_material(
        ...
        return self._delete_thermal_interface_material_oapg(
