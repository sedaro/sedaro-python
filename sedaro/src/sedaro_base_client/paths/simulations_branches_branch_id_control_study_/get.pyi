...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['StudyJob']:
            return StudyJob

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['StudyJob'], typing.List['StudyJob']],
    ...
    def __getitem__(self, i: int) -> 'StudyJob':
