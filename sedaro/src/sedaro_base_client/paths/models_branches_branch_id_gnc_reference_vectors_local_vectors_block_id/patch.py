...
# body param
SchemaForRequestBodyApplicationJson = LocalVectorUpdate


request_body_local_vector_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_local_vector_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_local_vector_update.serialize(body, content_type)
...
class UpdateLocalVector(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_local_vector(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_local_vector(
        ...
        return self._update_local_vector_oapg(
            body=body,
