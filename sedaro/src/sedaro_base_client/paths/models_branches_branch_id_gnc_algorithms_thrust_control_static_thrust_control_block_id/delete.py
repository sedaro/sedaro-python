...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_static_thrust_control_algorithm_oapg(
        self,
...
class DeleteStaticThrustControlAlgorithm(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_static_thrust_control_algorithm(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_static_thrust_control_algorithm(
        ...
        return self._delete_static_thrust_control_algorithm_oapg(
