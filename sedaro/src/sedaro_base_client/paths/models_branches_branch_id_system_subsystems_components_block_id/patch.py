...
# body param
SchemaForRequestBodyApplicationJson = ComponentUpdate


request_body_component_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_component_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_component_update.serialize(body, content_type)
...
class UpdateComponent(BaseApi):
    ...
    def update_component(
        ...
        return self._update_component_oapg(
            body=body,
