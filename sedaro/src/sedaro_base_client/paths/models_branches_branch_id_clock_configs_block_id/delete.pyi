...
class BaseApi(api_client.Api):
    ...
    def _delete_simulation_clock_configuration_oapg(
        self: api_client.Api,
...
class DeleteSimulationClockConfiguration(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def delete_simulation_clock_configuration(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._delete_simulation_clock_configuration_oapg(
