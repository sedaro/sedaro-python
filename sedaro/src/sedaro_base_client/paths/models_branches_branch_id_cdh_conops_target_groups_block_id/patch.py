...
# body param
SchemaForRequestBodyApplicationJson = TargetGroupUpdate


request_body_target_group_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_target_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_target_group_update.serialize(body, content_type)
...
class UpdateTargetGroup(BaseApi):
    ...
    def update_target_group(
        ...
        return self._update_target_group_oapg(
            body=body,
