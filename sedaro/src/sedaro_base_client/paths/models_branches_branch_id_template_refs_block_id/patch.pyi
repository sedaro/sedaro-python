...
SchemaFor200ResponseBodyApplicationJson = ScenarioBlockUpdateRes
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_agent_template_reference_oapg(
        self,
...
class UpdateAgentTemplateReference(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_agent_template_reference(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_agent_template_reference(
        ...
        return self._update_agent_template_reference_oapg(
            body=body,
