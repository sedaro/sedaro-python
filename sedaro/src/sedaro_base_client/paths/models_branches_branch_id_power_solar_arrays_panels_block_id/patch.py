...
# body param
SchemaForRequestBodyApplicationJson = SolarPanelUpdate


request_body_solar_panel_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_solar_panel_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_solar_panel_update.serialize(body, content_type)
...
class UpdateSolarPanel(BaseApi):
    ...
    def update_solar_panel(
        ...
        return self._update_solar_panel_oapg(
            body=body,
