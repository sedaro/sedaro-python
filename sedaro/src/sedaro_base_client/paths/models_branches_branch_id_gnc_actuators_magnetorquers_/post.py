...
# body param
SchemaForRequestBodyApplicationJson = MagnetorquerCreate


request_body_magnetorquer_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_magnetorquer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_magnetorquer_create.serialize(body, content_type)
...
class CreateMagnetorquer(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_magnetorquer(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def create_magnetorquer(
        ...
        return self._create_magnetorquer_oapg(
            body=body,
