...
# body param
SchemaForRequestBodyApplicationJson = BatteryCellCreate


request_body_battery_cell_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_battery_cell_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_battery_cell_create.serialize(body, content_type)
...
class CreateBatteryCell(BaseApi):
    ...
    def create_battery_cell(
        ...
        return self._create_battery_cell_oapg(
            body=body,
