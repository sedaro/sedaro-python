...
# Query params
LatestSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'latest': typing.Union[LatestSchema, bool, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = JobGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_simulation_status_oapg(
        self,
...
class GetSimulationStatus(BaseApi):
    ...
    def get_simulation_status(
        ...
        return self._get_simulation_status_oapg(
