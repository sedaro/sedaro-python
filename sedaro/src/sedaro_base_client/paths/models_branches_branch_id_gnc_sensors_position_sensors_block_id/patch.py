...
# body param
SchemaForRequestBodyApplicationJson = PositionSensorUpdate


request_body_position_sensor_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_position_sensor_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_position_sensor_update.serialize(body, content_type)
