...
# body param
SchemaForRequestBodyApplicationJson = SpaceTargetUpdate


request_body_space_target_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_space_target_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_space_target_update.serialize(body, content_type)
...
class UpdateSpaceTarget(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_space_target(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_space_target(
        ...
        return self._update_space_target_oapg(
            body=body,
