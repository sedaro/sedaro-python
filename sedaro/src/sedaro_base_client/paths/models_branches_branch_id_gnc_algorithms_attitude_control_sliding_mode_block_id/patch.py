...
# body param
SchemaForRequestBodyApplicationJson = SlidingModeAlgorithmUpdate


request_body_sliding_mode_algorithm_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_sliding_mode_algorithm_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sliding_mode_algorithm_update.serialize(body, content_type)
