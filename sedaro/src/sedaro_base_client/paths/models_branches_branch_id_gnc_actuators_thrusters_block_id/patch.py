...
# body param
SchemaForRequestBodyApplicationJson = ThrusterUpdate


request_body_thruster_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_thruster_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_thruster_update.serialize(body, content_type)
...
class UpdateThruster(BaseApi):
    ...
    def update_thruster(
        ...
        return self._update_thruster_oapg(
            body=body,
