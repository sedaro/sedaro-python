...
SchemaFor200ResponseBodyApplicationJson = BranchChangesRes
...
class GetBranchChanges(BaseApi):
    ...
    def get_branch_changes(
        ...
        return self._get_branch_changes_oapg(
