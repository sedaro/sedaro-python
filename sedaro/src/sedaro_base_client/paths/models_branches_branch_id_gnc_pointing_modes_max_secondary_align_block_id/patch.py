...
# body param
SchemaForRequestBodyApplicationJson = MaxAlignPointingModeUpdate


request_body_max_align_pointing_mode_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_max_align_pointing_mode_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_max_align_pointing_mode_update.serialize(body, content_type)
