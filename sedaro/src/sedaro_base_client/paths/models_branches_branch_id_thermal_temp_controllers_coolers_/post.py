...
# body param
SchemaForRequestBodyApplicationJson = CoolerCreate


request_body_cooler_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_cooler_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cooler_create.serialize(body, content_type)
...
class CreateCooler(BaseApi):
    ...
    def create_cooler(
        ...
        return self._create_cooler_oapg(
            body=body,
