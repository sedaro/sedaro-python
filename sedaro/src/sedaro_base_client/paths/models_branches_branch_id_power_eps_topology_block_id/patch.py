...
# body param
SchemaForRequestBodyApplicationJson = TopologyUpdate


request_body_topology_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_topology_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_topology_update.serialize(body, content_type)
...
class UpdateTopology(BaseApi):
    ...
    def update_topology(
        ...
        return self._update_topology_oapg(
            body=body,
