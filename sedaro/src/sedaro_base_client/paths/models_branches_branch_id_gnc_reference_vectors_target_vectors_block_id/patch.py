...
# body param
SchemaForRequestBodyApplicationJson = TargetVectorUpdate


request_body_target_vector_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_target_vector_oapg(
        self,
    ...
    def _update_target_vector_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_target_vector_update.serialize(body, content_type)
...
class UpdateTargetVector(BaseApi):
    ...
    def update_target_vector(
        ...
        return self._update_target_vector_oapg(
            body=body,
