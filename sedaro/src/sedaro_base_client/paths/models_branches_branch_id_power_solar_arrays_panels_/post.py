...
# body param
SchemaForRequestBodyApplicationJson = SolarPanelCreate


request_body_solar_panel_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_solar_panel_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_solar_panel_create.serialize(body, content_type)
...
class CreateSolarPanel(BaseApi):
    ...
    def create_solar_panel(
        ...
        return self._create_solar_panel_oapg(
            body=body,
