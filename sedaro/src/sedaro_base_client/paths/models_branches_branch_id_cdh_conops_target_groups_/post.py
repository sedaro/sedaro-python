...
# body param
SchemaForRequestBodyApplicationJson = TargetGroupCreate


request_body_target_group_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_target_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_target_group_create.serialize(body, content_type)
...
class CreateTargetGroup(BaseApi):
    ...
    def create_target_group(
        ...
        return self._create_target_group_oapg(
            body=body,
