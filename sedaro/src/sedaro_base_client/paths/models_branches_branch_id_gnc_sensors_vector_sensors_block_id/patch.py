...
# body param
SchemaForRequestBodyApplicationJson = VectorSensorUpdate


request_body_vector_sensor_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_vector_sensor_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_vector_sensor_update.serialize(body, content_type)
