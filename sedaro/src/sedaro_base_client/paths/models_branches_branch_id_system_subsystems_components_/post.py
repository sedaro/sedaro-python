...
# body param
SchemaForRequestBodyApplicationJson = ComponentCreate


request_body_component_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_component_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_component_create.serialize(body, content_type)
