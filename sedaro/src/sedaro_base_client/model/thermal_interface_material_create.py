...
class ThermalInterfaceMaterialCreate(
    schemas.DictSchema
):
...
relationship fields.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resistivity", "thickness", "hotTempRating", "coldTempRating", "id", "partNumber", "manufacturer", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resistivity", "thickness", "hotTempRating", "coldTempRating", "id", "partNumber", "manufacturer", ], str]):
