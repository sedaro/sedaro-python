...
class PhotovoltaicPowerProcessor(
    schemas.DictSchema
):
    ...
    A PhotovoltaicPowerProcessor Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "PhotovoltaicPowerProcessor": "PHOTOVOLTAIC_POWER_PROCESSOR",
                    }
                
                @schemas.classproperty
                def PHOTOVOLTAIC_POWER_PROCESSOR(cls):
                    return cls("PhotovoltaicPowerProcessor")
            __annotations__ = {
                "name": name,
                "id": id,
