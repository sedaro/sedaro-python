    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TargetInFovCondition": "TARGET_IN_FOV_CONDITION",
                    }
                
                @schemas.classproperty
                def TARGET_IN_FOV_CONDITION(cls):
                    return cls("TargetInFovCondition")
            __annotations__ = {
                "name": name,
                "id": id,
