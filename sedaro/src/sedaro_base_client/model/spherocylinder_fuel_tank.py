...
class SpherocylinderFuelTank(
    ...
    A SpherocylinderFuelTank Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SpherocylinderFuelTank": "SPHEROCYLINDER_FUEL_TANK",
                    }
                
                @schemas.classproperty
                def SPHEROCYLINDER_FUEL_TANK(cls):
                    return cls("SpherocylinderFuelTank")
            __annotations__ = {
                "name": name,
                "capacity": capacity,
                "priority": priority,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cylinderLength"], typing_extensions.Literal["capDiameter"], typing_extensions.Literal["name"], typing_extensions.Literal["location"], typing_extensions.Literal["priority"], typing_extensions.Literal["wetMass"], typing_extensions.Literal["capacity"], typing_extensions.Literal["id"], typing_extensions.Literal["partNumber"], typing_extensions.Literal["manufacturer"], typing_extensions.Literal["hotTempRating"], typing_extensions.Literal["coldTempRating"], typing_extensions.Literal["thermalCapacitance"], typing_extensions.Literal["cotsTemplate"], typing_extensions.Literal["subsystem"], typing_extensions.Literal["loadStates"], typing_extensions.Literal["dataSinks"], typing_extensions.Literal["dataSources"], typing_extensions.Literal["dataStorage"], typing_extensions.Literal["dataModes"], typing_extensions.Literal["powerConsumed"], typing_extensions.Literal["dissipations"], typing_extensions.Literal["hotMargin"], typing_extensions.Literal["coldMargin"], typing_extensions.Literal["temperature"], typing_extensions.Literal["storage"], typing_extensions.Literal["readRate"], typing_extensions.Literal["writeRate"], typing_extensions.Literal["reservoir"], typing_extensions.Literal["flowRate"], typing_extensions.Literal["inertia"], typing_extensions.Literal["orientationVector"], typing_extensions.Literal["type"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
