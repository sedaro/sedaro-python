...
class MagnetorquerUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "bodyFrameVector", "ratedMagneticMoment", "powerAtRatedMagneticMoment", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "busRegulator", "topology", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "bodyFrameVector", "ratedMagneticMoment", "powerAtRatedMagneticMoment", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "busRegulator", "topology", ], str]):
