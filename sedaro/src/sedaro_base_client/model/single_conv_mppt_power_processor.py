...
class SingleConvMpptPowerProcessor(
    ...
    A SingleConvMpptPowerProcessor Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SingleConvMpptPowerProcessor": "SINGLE_CONV_MPPT_POWER_PROCESSOR",
                    }
                
                @schemas.classproperty
                def SINGLE_CONV_MPPT_POWER_PROCESSOR(cls):
                    return cls("SingleConvMpptPowerProcessor")
            __annotations__ = {
                "name": name,
                "id": id,
