...
relationship fields.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "priority", "pointingMode", "id", "minOccurrenceDuration", "maxOccurrenceDuration", "minTimeBetweenOccurrences", "conditions", "dataGenerationModes", "activeDataInterfaces", "sameTargetConditionGroupings", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "priority", "pointingMode", "id", "minOccurrenceDuration", "maxOccurrenceDuration", "minTimeBetweenOccurrences", "conditions", "dataGenerationModes", "activeDataInterfaces", "sameTargetConditionGroupings", ], str]):
