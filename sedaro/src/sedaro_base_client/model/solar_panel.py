...
relationship fields.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "subsystem", "numSeries", "numParallel", "blockingDiodeDrop", "cell", "surface", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "componentType", "cotsTemplate", "loadStates", "satellite", "thermal_interface_A", "thermal_interface_B", "dataSinks", "dataSources", "dataStorage", "dataModes", "powerConsumed", "dissipations", "hotMargin", "coldMargin", "tempControllers", "temperature", "storage", "readRate", "writeRate", "array", "idealMaxPowerVoltage", "idealMaxPowerCurrent", "idealOpenCircuitVoltage", "idealShortCircuitCurrent", "equivSeriesResistance", "equivShuntResistance", "equivDarkCurrent", "equivLightCurrent", "current", "voltage", "maxPower", "maxPowerVoltage", "maxPowerCurrent", "openCircuitVoltage", "power", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
