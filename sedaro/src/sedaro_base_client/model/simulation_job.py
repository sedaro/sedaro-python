...
class SimulationJob(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "bedRef", "dataArray", "startTime", "stopTime", "realTime", "progress", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "bedRef", "dataArray", "startTime", "stopTime", "realTime", "progress", ], str]):
