...
class RepoUpdateReq(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "dataType", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "dataType", "description", ], str]):
