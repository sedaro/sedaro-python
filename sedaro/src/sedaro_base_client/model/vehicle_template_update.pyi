...
class VehicleTemplateUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["conOps"], typing_extensions.Literal["satellite"], typing_extensions.Literal["missionOrbit"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["conOps"], typing_extensions.Literal["satellite"], typing_extensions.Literal["missionOrbit"], ]):
