...
class VectorSensorUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "oneSigmaPerAxisError", "referenceVector", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "fieldOfView", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "oneSigmaPerAxisError", "referenceVector", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", "fieldOfView", ], str]):
