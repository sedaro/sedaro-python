...
class ScenarioModelRoot(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "ScenarioModelRoot": "SCENARIO_MODEL_ROOT",
                    }
                
                @schemas.classproperty
                def SCENARIO_MODEL_ROOT(cls):
                    return cls("ScenarioModelRoot")
            __annotations__ = {
                "migrated": migrated,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["migrated"], typing_extensions.Literal["clockConfig"], typing_extensions.Literal["type"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["migrated"], typing_extensions.Literal["clockConfig"], typing_extensions.Literal["type"], ]):
