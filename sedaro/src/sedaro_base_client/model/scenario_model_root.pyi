...
class ScenarioModelRoot(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clockConfig"], typing_extensions.Literal["seed"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clockConfig"], typing_extensions.Literal["seed"], ]):
