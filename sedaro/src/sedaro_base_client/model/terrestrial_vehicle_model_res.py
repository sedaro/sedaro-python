...
class TerrestrialVehicleModelRes(
    schemas.DictSchema
):
    ...
    Class for TerrestrialVehicle with meta attributes
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TerrestrialVehicleModelRes": "TERRESTRIAL_VEHICLE_MODEL_RES",
                    }
                
                @schemas.classproperty
                def TERRESTRIAL_VEHICLE_MODEL_RES(cls):
                    return cls("TerrestrialVehicleModelRes")
            __annotations__ = {
                "cadKey": cadKey,
