...
class SpherocylinderFuelTankCreate(
    schemas.DictSchema
):
...
relationship fields.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class componentType(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SPHEROCYLINDER_FUEL_TANK": "SPHEROCYLINDER_FUEL_TANK",
                    }
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "capacity", "priority", "location", "reservoir", "componentType", "capDiameter", "cylinderLength", "orientationVector", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "capacity", "priority", "location", "reservoir", "componentType", "capDiameter", "cylinderLength", "orientationVector", "id", "partNumber", "manufacturer", "hotTempRating", "coldTempRating", "thermalCapacitance", ], str]):
