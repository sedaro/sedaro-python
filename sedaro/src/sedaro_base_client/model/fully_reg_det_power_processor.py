...
class FullyRegDetPowerProcessor(
    ...
    A FullyRegDetPowerProcessor Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "FullyRegDetPowerProcessor": "FULLY_REG_DET_POWER_PROCESSOR",
                    }
                
                @schemas.classproperty
                def FULLY_REG_DET_POWER_PROCESSOR(cls):
                    return cls("FullyRegDetPowerProcessor")
            __annotations__ = {
                "name": name,
                "id": id,
