...
class DynamicallyLoadedComponent(
    ...
    A DynamicallyLoadedComponent Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "DynamicallyLoadedComponent": "DYNAMICALLY_LOADED_COMPONENT",
                    }
                
                @schemas.classproperty
                def DYNAMICALLY_LOADED_COMPONENT(cls):
                    return cls("DynamicallyLoadedComponent")
            __annotations__ = {
                "name": name,
                "id": id,
