...
class BranchChangesRes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def edited() -> typing.Type['Metamodel']:
                return Metamodel
        
            @staticmethod
            def committed() -> typing.Type['Metamodel']:
                return Metamodel
            __annotations__ = {
                "edited": edited,
                "committed": committed,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["edited"]) -> 'Metamodel': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["committed"]) -> 'Metamodel': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["edited"]) -> 'Metamodel': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["committed"]) -> 'Metamodel': ...
