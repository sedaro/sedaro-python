...
class AngularVelocityAttitude14(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rpm"], typing_extensions.Literal["deg/s"], typing_extensions.Literal["rad/s"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rpm"], typing_extensions.Literal["deg/s"], typing_extensions.Literal["rad/s"], ]):
