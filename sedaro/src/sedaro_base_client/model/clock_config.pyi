...
class ClockConfig(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def CLOCK_CONFIG(cls):
                    return cls("ClockConfig")
            __annotations__ = {
                "startTime": startTime,
                "stopTime": stopTime,
                "id": id,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["startTime"], typing_extensions.Literal["stopTime"], typing_extensions.Literal["id"], typing_extensions.Literal["realTime"], typing_extensions.Literal["syncTime"], typing_extensions.Literal["type"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startTime"], typing_extensions.Literal["stopTime"], typing_extensions.Literal["id"], typing_extensions.Literal["realTime"], typing_extensions.Literal["syncTime"], typing_extensions.Literal["type"], ]):
