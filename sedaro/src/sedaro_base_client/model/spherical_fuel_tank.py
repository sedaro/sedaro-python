    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SphericalFuelTank": "SPHERICAL_FUEL_TANK",
                    }
                
                @schemas.classproperty
                def SPHERICAL_FUEL_TANK(cls):
                    return cls("SphericalFuelTank")
            __annotations__ = {
                "name": name,
                "capacity": capacity,
                "priority": priority,
