...
class StudyJob(
            ...
            class status(
                ...
                class MetaOapg:
                    ...
                    def all_of(cls):
                        ...
                        # loading
                        return [
                            ServicesModelSpecModelsStudyJobStatuses,
                        ]
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "scenarioHash", "overrideID", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "scenarioHash", "overrideID", ], str]):
