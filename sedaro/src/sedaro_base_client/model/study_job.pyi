...
class StudyJob(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "scenarioHash", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "scenarioHash", ], str]):
