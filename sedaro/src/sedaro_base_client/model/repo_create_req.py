...
class RepoCreateReq(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "workspace", "metamodelType", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "workspace", "metamodelType", "description", ], str]):
