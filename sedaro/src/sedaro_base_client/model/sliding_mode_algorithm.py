...
class SlidingModeAlgorithm(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SlidingModeAlgorithm": "SLIDING_MODE_ALGORITHM",
                    }
                
                @schemas.classproperty
                def SLIDING_MODE_ALGORITHM(cls):
                    return cls("SlidingModeAlgorithm")
            __annotations__ = {
                "name": name,
                "gainK": gainK,
                "gainG": gainG,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["epsilon"], typing_extensions.Literal["gainG"], typing_extensions.Literal["gainK"], typing_extensions.Literal["name"], typing_extensions.Literal["gainC"], typing_extensions.Literal["id"], typing_extensions.Literal["rate"], typing_extensions.Literal["actuators"], typing_extensions.Literal["reactionWheelCommands"], typing_extensions.Literal["magnetorquerCommands"], typing_extensions.Literal["type"], ]):
