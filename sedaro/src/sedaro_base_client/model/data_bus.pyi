...
class DataBus(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["interfaces"], typing_extensions.Literal["bitRate"], typing_extensions.Literal["type"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["interfaces"], typing_extensions.Literal["bitRate"], typing_extensions.Literal["type"], ]):
