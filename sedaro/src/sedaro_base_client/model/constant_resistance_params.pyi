...
class ConstantResistanceParams(
    schemas.DictSchema
):
    ...
    resistance: MetaOapg.properties.resistance
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resistance", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resistance"]) -> MetaOapg.properties.resistance: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resistance", ], str]):
