...
class SimulationJob(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["simulatedAgents"]
                    ) -> MetaOapg.properties.simulatedAgents: ...
    ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["simulatedAgents"]) -> MetaOapg.properties.simulatedAgents: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["realTime"]
                      ) -> typing.Union[MetaOapg.properties.realTime, schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["progress"]
                      ) -> typing.Union[MetaOapg.properties.progress, schemas.Unset]: ...
