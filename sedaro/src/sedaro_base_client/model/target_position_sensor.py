    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TargetPositionSensor": "TARGET_POSITION_SENSOR",
                    }
                
                @schemas.classproperty
                def TARGET_POSITION_SENSOR(cls):
                    return cls("TargetPositionSensor")
            __annotations__ = {
                "name": name,
