...
class SatelliteToSatelliteCondition(
    ...
    A SatelliteToSatelliteCondition Block
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["relationship"], typing_extensions.Literal["id"], typing_extensions.Literal["terminator"], typing_extensions.Literal["compliance"], typing_extensions.Literal["paramA"], typing_extensions.Literal["paramB"], typing_extensions.Literal["type"], ]):
