    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "VectorSensor": "VECTOR_SENSOR",
                    }
                
                @schemas.classproperty
                def VECTOR_SENSOR(cls):
                    return cls("VectorSensor")
            __annotations__ = {
                "name": name,
