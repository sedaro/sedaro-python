...
class TrackingFieldOfViewArticulationMode(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["opModes"], typing_extensions.Literal["fieldOfView"], typing_extensions.Literal["isActive"], typing_extensions.Literal["commandedArticulations"], typing_extensions.Literal["lockVector"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["opModes"], typing_extensions.Literal["fieldOfView"], typing_extensions.Literal["isActive"], typing_extensions.Literal["commandedArticulations"], typing_extensions.Literal["lockVector"], ]):
