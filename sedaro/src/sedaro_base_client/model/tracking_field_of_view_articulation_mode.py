...
class TrackingFieldOfViewArticulationMode(
    ...
    A TrackingFieldOfViewArticulationMode Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TrackingFieldOfViewArticulationMode": "TRACKING_FIELD_OF_VIEW_ARTICULATION_MODE",
                    }
                
                @schemas.classproperty
                def TRACKING_FIELD_OF_VIEW_ARTICULATION_MODE(cls):
                    return cls("TrackingFieldOfViewArticulationMode")
            __annotations__ = {
                "name": name,
                "id": id,
                "opModes": opModes,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["opModes"], typing_extensions.Literal["fieldOfView"], typing_extensions.Literal["isActive"], typing_extensions.Literal["commandedArticulations"], typing_extensions.Literal["lockVector"], typing_extensions.Literal["type"], ]):
