...
class TemperatureBase199(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["degF"], typing_extensions.Literal["degK"], typing_extensions.Literal["degC"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["degF"], typing_extensions.Literal["degK"], typing_extensions.Literal["degC"], ]):
