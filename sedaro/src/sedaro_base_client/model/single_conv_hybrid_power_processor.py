...
class SingleConvHybridPowerProcessor(
    ...
    A SingleConvHybridPowerProcessor Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SingleConvHybridPowerProcessor": "SINGLE_CONV_HYBRID_POWER_PROCESSOR",
                    }
                
                @schemas.classproperty
                def SINGLE_CONV_HYBRID_POWER_PROCESSOR(cls):
                    return cls("SingleConvHybridPowerProcessor")
            __annotations__ = {
                "name": name,
                "id": id,
