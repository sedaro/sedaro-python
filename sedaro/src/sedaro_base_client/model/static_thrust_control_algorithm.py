...
class StaticThrustControlAlgorithm(
    ...
    A StaticThrustControlAlgorithm Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "StaticThrustControlAlgorithm": "STATIC_THRUST_CONTROL_ALGORITHM",
                    }
                
                @schemas.classproperty
                def STATIC_THRUST_CONTROL_ALGORITHM(cls):
                    return cls("StaticThrustControlAlgorithm")
            __annotations__ = {
                "name": name,
                "id": id,
                "rate": rate,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["rate"], typing_extensions.Literal["thrusters"], typing_extensions.Literal["type"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["rate"], typing_extensions.Literal["thrusters"], typing_extensions.Literal["type"], ]):
