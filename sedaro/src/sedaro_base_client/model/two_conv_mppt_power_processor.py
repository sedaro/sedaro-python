...
class TwoConvMpptPowerProcessor(
    ...
    A TwoConvMpptPowerProcessor Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TwoConvMpptPowerProcessor": "TWO_CONV_MPPT_POWER_PROCESSOR",
                    }
                
                @schemas.classproperty
                def TWO_CONV_MPPT_POWER_PROCESSOR(cls):
                    return cls("TwoConvMpptPowerProcessor")
            __annotations__ = {
                "name": name,
                "id": id,
