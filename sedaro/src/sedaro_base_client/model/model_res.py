...
class ModelRes(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blocks"], typing_extensions.Literal["index"], typing_extensions.Literal["migrated"], typing_extensions.Literal["issues"], typing_extensions.Literal["_relationships"], typing_extensions.Literal["_blockNames"], typing_extensions.Literal["_supers"], typing_extensions.Literal["type"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
