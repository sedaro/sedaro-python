...
class CooperativeTransmitInterface(
    schemas.DictSchema
):
    ...
    A CooperativeTransmitInterface Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "CooperativeTransmitInterface": "COOPERATIVE_TRANSMIT_INTERFACE",
                    }
                
                @schemas.classproperty
                def COOPERATIVE_TRANSMIT_INTERFACE(cls):
                    return cls("CooperativeTransmitInterface")
            __annotations__ = {
                "name": name,
                "onBitRate": onBitRate,
