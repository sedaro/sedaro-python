...
class ActivePointingMode(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "conOps", "lockBodyFrameVector", "acAlgorithm", "id", "operationalModes", "odAlgorithm", "adAlgorithm", "reactionWheelCommands", "magnetorquerCommands", "lockVector", "commandedAttitude", "commandedAngularRates", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "conOps", "lockBodyFrameVector", "acAlgorithm", "id", "operationalModes", "odAlgorithm", "adAlgorithm", "reactionWheelCommands", "magnetorquerCommands", "lockVector", "commandedAttitude", "commandedAngularRates", ], str]):
