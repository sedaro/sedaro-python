...
class SatelliteToTargetCondition(
    ...
    A SatelliteToTargetCondition Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SatelliteToTargetCondition": "SATELLITE_TO_TARGET_CONDITION",
                    }
                
                @schemas.classproperty
                def SATELLITE_TO_TARGET_CONDITION(cls):
                    return cls("SatelliteToTargetCondition")
            __annotations__ = {
                "name": name,
