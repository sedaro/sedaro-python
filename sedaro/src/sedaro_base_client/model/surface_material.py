...
class SurfaceMaterial(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def SURFACE_MATERIAL(cls):
                    return cls("SurfaceMaterial")
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["diffuseSolarReflectivity"], typing_extensions.Literal["specularSolarReflectivity"], typing_extensions.Literal["solarAbsorptivity"], typing_extensions.Literal["irEmissivity"], typing_extensions.Literal["id"], typing_extensions.Literal["partNumber"], typing_extensions.Literal["manufacturer"], typing_extensions.Literal["hotTempRating"], typing_extensions.Literal["coldTempRating"], typing_extensions.Literal["type"], ]):
