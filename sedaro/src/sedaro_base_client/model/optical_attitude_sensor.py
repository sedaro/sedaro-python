    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "OpticalAttitudeSensor": "OPTICAL_ATTITUDE_SENSOR",
                    }
                
                @schemas.classproperty
                def OPTICAL_ATTITUDE_SENSOR(cls):
                    return cls("OpticalAttitudeSensor")
            __annotations__ = {
                "name": name,
