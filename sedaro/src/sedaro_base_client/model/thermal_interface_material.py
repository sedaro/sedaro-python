...
class ThermalInterfaceMaterial(
    ...
    A ThermalInterfaceMaterial Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "ThermalInterfaceMaterial": "THERMAL_INTERFACE_MATERIAL",
                    }
                
                @schemas.classproperty
                def THERMAL_INTERFACE_MATERIAL(cls):
                    return cls("ThermalInterfaceMaterial")
            __annotations__ = {
                "name": name,
