...
class TargetGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["targetType"], typing_extensions.Literal["id"], typing_extensions.Literal["sortValue"], typing_extensions.Literal["sortOrder"], typing_extensions.Literal["targets"], typing_extensions.Literal["filterConditions"], typing_extensions.Literal["targetAssociations"], typing_extensions.Literal["activeTarget"], typing_extensions.Literal["type"], ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        sortValue: typing.Union[MetaOapg.properties.sortValue, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        sortOrder: typing.Union[MetaOapg.properties.sortOrder, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
