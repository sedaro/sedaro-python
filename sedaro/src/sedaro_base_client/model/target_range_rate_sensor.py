...
class TargetRangeRateSensor(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TargetRangeRateSensor": "TARGET_RANGE_RATE_SENSOR",
                    }
                
                @schemas.classproperty
                def TARGET_RANGE_RATE_SENSOR(cls):
                    return cls("TargetRangeRateSensor")
            __annotations__ = {
                "name": name,
    ...
    oneSigmaVelocityError: MetaOapg.properties.oneSigmaVelocityError
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["oneSigmaVelocityError"]) -> MetaOapg.properties.oneSigmaVelocityError: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        oneSigmaVelocityError: typing.Union[MetaOapg.properties.oneSigmaVelocityError, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
