...
class TargetVector(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def TARGET_VECTOR(cls):
                    return cls("TargetVector")
            __annotations__ = {
                "name": name,
                "id": id,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["representation"], typing_extensions.Literal["truth"], typing_extensions.Literal["estimate"], typing_extensions.Literal["eclipsed"], typing_extensions.Literal["referenceTarget"], typing_extensions.Literal["type"], ]):
