...
class ConOps(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["metamodel"], typing_extensions.Literal["conditions"], typing_extensions.Literal["groupConditions"], typing_extensions.Literal["targets"], typing_extensions.Literal["targetGroups"], typing_extensions.Literal["operationalModes"], typing_extensions.Literal["pointingModes"], typing_extensions.Literal["activeOpMode"], ]):
