...
class TargetToTargetCondition(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class conditionType(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TargetToTargetCondition": "TARGET_TO_TARGET_CONDITION",
                    }
                
                @schemas.classproperty
                def TARGET_TO_TARGET_CONDITION(cls):
                    return cls("TargetToTargetCondition")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["targetAParam"], typing_extensions.Literal["name"], typing_extensions.Literal["relationship"], typing_extensions.Literal["targetBParam"], typing_extensions.Literal["id"], typing_extensions.Literal["metamodel"], typing_extensions.Literal["conOps"], typing_extensions.Literal["operationalModes"], typing_extensions.Literal["terminator"], typing_extensions.Literal["compliance"], typing_extensions.Literal["conditionType"], typing_extensions.Literal["targetA"], typing_extensions.Literal["targetB"], ]):
