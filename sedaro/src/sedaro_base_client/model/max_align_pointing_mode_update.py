...
relationship fields.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "lockBodyFrameVector", "acAlgorithm", "id", "odAlgorithm", "adAlgorithm", "tcAlgorithm", "lockVector", "maxAlignBodyFrameVector", "maxAlignVector", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "lockBodyFrameVector", "acAlgorithm", "id", "odAlgorithm", "adAlgorithm", "tcAlgorithm", "lockVector", "maxAlignBodyFrameVector", "maxAlignVector", ], str]):
