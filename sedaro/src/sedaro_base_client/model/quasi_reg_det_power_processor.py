...
class QuasiRegDetPowerProcessor(
    ...
    A QuasiRegDetPowerProcessor Block
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "QuasiRegDetPowerProcessor": "QUASI_REG_DET_POWER_PROCESSOR",
                    }
                
                @schemas.classproperty
                def QUASI_REG_DET_POWER_PROCESSOR(cls):
                    return cls("QuasiRegDetPowerProcessor")
            __annotations__ = {
                "name": name,
                "id": id,
