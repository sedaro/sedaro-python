    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "LaserCommModule": "LASER_COMM_MODULE",
                    }
                
                @schemas.classproperty
                def LASER_COMM_MODULE(cls):
                    return cls("LaserCommModule")
            __annotations__ = {
                "name": name,
                "id": id,
