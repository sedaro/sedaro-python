...
relationship fields.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class componentType(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "LASER_COMM_MODULE": "LASER_COMM_MODULE",
                    }
                
                @schemas.classproperty
                def LASER_COMM_MODULE(cls):
                    return cls("LASER_COMM_MODULE")
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        mode: typing.Union[MetaOapg.properties.mode, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
