...
class TargetRangeSensor(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "TargetRangeSensor": "TARGET_RANGE_SENSOR",
                    }
                
                @schemas.classproperty
                def TARGET_RANGE_SENSOR(cls):
                    return cls("TargetRangeSensor")
            __annotations__ = {
                "name": name,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["oneSigmaDistanceError"]) -> MetaOapg.properties.oneSigmaDistanceError: ...
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        oneSigmaDistanceError: typing.Union[MetaOapg.properties.oneSigmaDistanceError, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        measurement: typing.Union[MetaOapg.properties.measurement, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
