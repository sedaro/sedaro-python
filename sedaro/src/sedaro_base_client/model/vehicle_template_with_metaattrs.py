...
class VehicleTemplateWithMetaattrs(
    schemas.DictSchema
):
    ...
    Class for when this template is in a response with meta attributes
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def position() -> typing.Type['PositionBase220']:
                return PositionBase220
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["position"]) -> 'PositionBase220': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["position"]) -> typing.Union['PositionBase220', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        position: typing.Union['PositionBase220', schemas.Unset] = schemas.unset,
