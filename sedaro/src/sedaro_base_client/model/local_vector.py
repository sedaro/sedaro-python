...
relationship fields.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "vectorType", "localPointingDirection", "id", "truth", "estimate", "eclipsed", "FOVConstraints", "directionSensors", "vectorSensors", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "vectorType", "localPointingDirection", "id", "truth", "estimate", "eclipsed", "FOVConstraints", "directionSensors", "vectorSensors", ], str]):
