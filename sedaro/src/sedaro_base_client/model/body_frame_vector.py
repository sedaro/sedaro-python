...
class BodyFrameVector(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "BodyFrameVector": "BODY_FRAME_VECTOR",
                    }
                
                @schemas.classproperty
                def BODY_FRAME_VECTOR(cls):
                    return cls("BodyFrameVector")
            __annotations__ = {
                "name": name,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["definitionParams"], typing_extensions.Literal["definitionType"], typing_extensions.Literal["id"], typing_extensions.Literal["unitVector"], typing_extensions.Literal["geocenterAngle"], typing_extensions.Literal["heliocenterAngle"], typing_extensions.Literal["type"], ]):
