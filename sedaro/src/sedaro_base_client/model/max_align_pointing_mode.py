    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "MaxAlignPointingMode": "MAX_ALIGN_POINTING_MODE",
                    }
                
                @schemas.classproperty
                def MAX_ALIGN_POINTING_MODE(cls):
                    return cls("MaxAlignPointingMode")
            __annotations__ = {
                "name": name,
                "id": id,
