...
class ActivePointingMode(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "conOps", "lockBodyFrameVector", "acAlgorithm", "id", "odAlgorithm", "adAlgorithm", "operationalModes", "reactionWheelCommands", "magnetorquerCommands", "commandedAttitude", "commandedAngularRates", "lockVector", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "pointingModeType", "conOps", "lockBodyFrameVector", "acAlgorithm", "id", "odAlgorithm", "adAlgorithm", "operationalModes", "reactionWheelCommands", "magnetorquerCommands", "commandedAttitude", "commandedAngularRates", "lockVector", ], str]):
