...
class GroupAndId(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["group", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["group", "id", ], str]):
