...
relationship fields.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "id", "targetAssociations", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "id", "targetAssociations", ], str]):
