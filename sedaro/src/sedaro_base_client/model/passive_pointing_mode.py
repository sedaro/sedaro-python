...
class PassivePointingMode(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "PassivePointingMode": "PASSIVE_POINTING_MODE",
                    }
                
                @schemas.classproperty
                def PASSIVE_POINTING_MODE(cls):
                    return cls("PassivePointingMode")
            __annotations__ = {
                "name": name,
                "id": id,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["odAlgorithm"], typing_extensions.Literal["adAlgorithm"], typing_extensions.Literal["tcAlgorithm"], typing_extensions.Literal["reactionWheelCommands"], typing_extensions.Literal["magnetorquerCommands"], typing_extensions.Literal["commandedAttitude"], typing_extensions.Literal["commandedAngularRates"], typing_extensions.Literal["type"], ]):
