...
relationship fields.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def loadDefParams() -> typing.Type['ConstantPower']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["loadDefParams"]) -> 'ConstantPower': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["loadDefParams"]) -> 'ConstantPower': ...
