...
class CrudRes(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blocks", "delete", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["blocks", "delete", ], str]):
