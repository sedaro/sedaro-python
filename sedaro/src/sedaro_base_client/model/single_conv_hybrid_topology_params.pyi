...
class SingleConvHybridTopologyParams(
    schemas.DictSchema
):
    ...
    bypassBlockingDiodeDrop: MetaOapg.properties.bypassBlockingDiodeDrop
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bypassBlockingDiodeDrop"]) -> MetaOapg.properties.bypassBlockingDiodeDrop: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["outputPowerRating"]) -> MetaOapg.properties.outputPowerRating: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bcrEfficiency"], typing_extensions.Literal["bypassBlockingDiodeDrop"], typing_extensions.Literal["outputPowerRating"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bypassBlockingDiodeDrop"]) -> MetaOapg.properties.bypassBlockingDiodeDrop: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["outputPowerRating"]) -> MetaOapg.properties.outputPowerRating: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bcrEfficiency"], typing_extensions.Literal["bypassBlockingDiodeDrop"], typing_extensions.Literal["outputPowerRating"], ]):
