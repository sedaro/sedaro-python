# sedaro_base_client.model.surface_material_bg.SurfaceMaterialBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**SurfaceMaterial**](SurfaceMaterial.md) | [**SurfaceMaterial**](SurfaceMaterial.md) | any string name can be used but the value must be the correct type | [optional] 
