# sedaro_base_client.model.fov_constraint_bg.FOVConstraintBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**FOVConstraint**](FOVConstraint.md) | [**FOVConstraint**](FOVConstraint.md) | any string name can be used but the value must be the correct type | [optional] 
