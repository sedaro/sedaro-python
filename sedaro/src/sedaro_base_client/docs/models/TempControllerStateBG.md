# sedaro_base_client.model.temp_controller_state_bg.TempControllerStateBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**TempControllerState**](TempControllerState.md) | [**TempControllerState**](TempControllerState.md) | any string name can be used but the value must be the correct type | [optional] 
