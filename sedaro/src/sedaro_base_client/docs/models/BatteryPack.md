# sedaro_base_client.model.battery_pack.BatteryPack
...
**battery** | str,  | str,  | Relationship to a &#x60;Battery&#x60; block. Reverse key: &#x60;Battery.packs&#x60;. On delete: &#x60;RESTRICT&#x60; (prevent referenced block from being deleted while relationship to this one exists). | 
**cell** | str,  | str,  | Relationship to a &#x60;BatteryCell&#x60; block. Reverse key: &#x60;BatteryCell.packs&#x60;. On delete: &#x60;RESTRICT&#x60; (prevent referenced block from being deleted while relationship to this one exists). | 
**id** | str,  | str,  |  | [optional] 
...
**componentType** | str,  | str,  |  | [optional] must be one of ["BATTERY_PACK", ] if omitted the server will use the default value of "BATTERY_PACK"
