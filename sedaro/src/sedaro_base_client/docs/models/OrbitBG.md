# sedaro_base_client.model.orbit_bg.OrbitBG
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**any_string_name** | [**Orbit**](Orbit.md) | [**Orbit**](Orbit.md) | any string name can be used but the value must be the correct type | [optional] 
