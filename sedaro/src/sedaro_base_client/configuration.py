...
conf = sedaro_base_client.Configuration(
    ...
    def __init__(
        ...
        """Constructor
        """
        self._base_path = "https://api.sedaro.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("sedaro_base_client")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'api_key_header_api_key' in self.api_key:
            auth['api_key_header_api_key'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X_API_KEY',
        ...
        if 'api_key_header_auth_handle' in self.api_key:
            auth['api_key_header_auth_handle'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X_AUTH_HANDLE',
                'value': self.get_api_key_with_prefix(
