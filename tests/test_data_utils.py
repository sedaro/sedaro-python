...
def test_set_nested_and_numeric():
    ...
    assert set_numeric_as_list({'a.0.0': [1, 2, 3], 'a.0.1': [4, 5, 6], 'a.1.0': [7, 8, 9], 'a.1.1': [10, 11, 12], 'b': [13, 14, 15]}) == {'a': [[[1, 4], [7, 10]], [[2, 5], [8, 11]], [[3, 6], [9, 12]]], 'b': [13, 14, 15]}
    assert set_numeric_as_list({'a.0.0.0': [1, 2, 3], 'a.0.0.1': [4, 5, 6], 'a.0.1.0': [7, 8, 9], 'a.0.1.1': [10, 11, 12], 'a.1.0.0': [13, 14, 15], 'a.1.0.1': [16, 17, 18], 'a.1.1.0': [19, 20, 21], 'a.1.1.1': [22, 23, 24]}) == {'a': [[[[1, 4], [7, 10]], [[13, 16], [19, 22]]], [[[2, 5], [8, 11]], [[14, 17], [20, 23]]], [[[3, 6], [9, 12]], [[15, 18], [21, 24]]]]}
